"""
THIS IS AN E2E WORKFLOW TO PARSE ANY PDFS
ITR EXTRACTS TEXTS FROM TEXT BOXES,
TEXTS FROM TABLES WITH FORMATTING INTACT
AND TEXTS FROM IMAGES USING GOOGLE VISION API.
REF -  https://towardsdatascience.com/extracting-text-from-pdf-files-with-python-a-comprehensive-guide-9fc4003d517
    ...
    for pagenum, page in enumerate(extract_pages(pdf_path)):
        ...
        for i,component in enumerate(page_elements):
            ...
            if isinstance(element, LTFigure):
                ...
                resp, image_text = analyze_image_from_file('PDF_image.png', feature_types=features)
